...
const documents = [
  // ─── SOPs ─────────────────────────────────────────────────────────────────
  {
    doc_id: 'SOP-01', title: 'Marketing & Lead Generation', category: 'SOP',
  ...
  {
    doc_id: 'SOP-02', title: 'Lead Capture & Classification', category: 'SOP',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'SOP-03', title: 'Quote & Proposal', category: 'SOP',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'SOP-04', title: 'Contract Execution & Onboarding Setup', category: 'SOP',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'SOP-05', title: 'Client Onboarding', category: 'SOP',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'SOP-06', title: 'Project Delivery', category: 'SOP',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'SOP-07', title: 'Project Closure & Handover', category: 'SOP',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'SOP-08', title: 'Billing & Accounts Receivable', category: 'SOP',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'SOP-09', title: 'Renewal, Upsell & Client Retention', category: 'SOP',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'SOP-10', title: 'Admin Dashboard Operations', category: 'SOP',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  // ─── Registers ────────────────────────────────────────────────────────────
  {
    doc_id: 'REG-01', title: 'Document Master Register', category: 'Register',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'REG-03', title: 'Context of the Organization', category: 'Register',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'REG-04', title: 'Employee Register', category: 'Register',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'REG-05', title: 'HSE Risk Register', category: 'Register',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'REG-06', title: 'Internal Audit Register', category: 'Register',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  // ─── Templates ────────────────────────────────────────────────────────────
  {
    doc_id: 'TPL-01', title: 'Quote Template', category: 'Template',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'TPL-02', title: 'Service Proposal Template', category: 'Template',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'TPL-03', title: 'Service Agreement', category: 'Template',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'TPL-04', title: 'Invoice Template', category: 'Template',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'TPL-05-14', title: 'Email Templates Collection (TPL-05 to TPL-14)', category: 'Template',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'TPL-09', title: 'Project Kickoff Agenda', category: 'Template',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'TPL-10', title: 'Weekly Status Report', category: 'Template',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  {
    doc_id: 'TPL-11', title: 'Project Closure Report', category: 'Template',
    version: '1.0', status: 'Active', owner: OWNER,
  ...
  // ─── Diagrams ─────────────────────────────────────────────────────────────
  {
    doc_id: 'DIA-01', title: 'Preqal End-to-End Process Flow', category: 'Diagram',
    version: '1.0', status: 'Active', owner: OWNER,
