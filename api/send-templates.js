...
// - FROM_EMAIL: donotreply@preqal.com
// - ALLOWED_ORIGIN: https://preqal.org (or https://www.preqal.org)
//
// Optional:
// - ZIP_FILE_URL: URL to fetch zip file from (if not bundled)
...
// CORS headers
const corsHeaders = {
  'Access-Control-Allow-Origin': process.env.ALLOWED_ORIGIN || 'https://preqal.org',
...
export default async function handler(req, res) {
  ...
  const allowedOrigins = new Set([
    "https://preqal.org",
    "https://www.preqal.org",
    // Optional (only if you test locally):
    // "http://localhost:5173",
  ]);
